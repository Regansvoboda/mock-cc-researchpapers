...
# so you can run the seed file multiple times without having duplicate entries in your database
    ...
    ra1 = ResearchAuthors(author = a1, research = r1)
    ra2 = ResearchAuthors(author = a2, research  = r2)
    ra3 = ResearchAuthors(author = a3, research = r3)
    ra4 = ResearchAuthors(author = a1, research = r3)
